...
/*! 
* \file	CoImageString.cpp
* \ingroup base
* \brief	·Í»ôµÛÂô»¥Ì© Ãùº¬¿Ðµ¹º÷¶¦ ¼³Ì©ÂÜ.
* \author	
*/
...
void CoImage::DrawString(long x, long y, const char* szText, COLORREF color, const char* szFont,
	long lSize, long lWeight, BYTE bItalic, BYTE bUnderline, const float rOpacity)
{
// 	int view_x, view_y;
// 	int coi = 0;
...
// 	italic_shear = !bItalic ? 0 : cvRound(font->vscale*.25*XY_ONE);
// 	thickness = font->thickness;
// 	line_type = font->line_type;
// 
// 	view_x = x << XY_SHIFT;
// 	view_y = (y << XY_SHIFT) + base_line*vscale;
// 
// 	for( i = 0; text[i] != '\0'; i++ )
// 	{
// 		int c = (uchar)text[i];
